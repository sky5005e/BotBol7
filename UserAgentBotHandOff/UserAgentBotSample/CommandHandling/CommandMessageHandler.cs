...
namespace UserAgentBot.CommandHandling
{
    /// <summary>
    ...
    public class CommandMessageHandler
    {
        ...
        public async virtual Task<bool> HandleCommandAsync(Activity activity)
        {
                ...
                || WasBotAddressedDirectly(activity, false))
            {
                ...
                {
                    case //Commands.CommandListOptions:
                        string command when (command.StartsWith(Commands.CommandListOptions)):
                        // Present all command options in a card
                        replyActivity = CreateCommandOptionsCard(activity);
                        wasHandled = true;
                        break;

                    case //Commands.CommandAddAggregationChannel:
                        string command when (command.StartsWith(Commands.CommandAddAggregationChannel)):
                    ...
                    case //Commands.CommandAcceptRequest:
                        string command when (command.StartsWith(Commands.CommandAcceptRequest) || command.StartsWith(Commands.CommandRejectRequest)):
                        // Accept/reject conversation request
                        //var command = Commands.CommandAcceptRequest;
                    ...
                    case //Commands.CommandDisconnect:
                        string command when (command.StartsWith(Commands.CommandDisconnect)):
                    ...
                    case //Commands.CommandListAllParties:
                        string command when (command.StartsWith(Commands.CommandListAllParties)):
                    ...
                    case //Commands.CommandListPendingRequests:
                        string command when (command.StartsWith(Commands.CommandListPendingRequests)):
                    ...
                    case //Commands.CommandListConnections:
                    string command when (command.StartsWith(Commands.CommandListConnections)):
                    ...
                    case //Commands.CommandListLastMessageRouterResults:
                    string command when (command.StartsWith(Commands.CommandListLastMessageRouterResults)):
