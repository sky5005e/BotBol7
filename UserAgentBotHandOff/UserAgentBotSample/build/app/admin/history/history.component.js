...
let HistoryComponent = class HistoryComponent {
    constructor(route, router, authenticationService, alertService, paService) {
        this.route = route;
        this.router = router;
    ...
    LoadMessage() {
        this.paService.get(global_1.Global.BASE_CAA_ENDPOINT + "chats/30")
...
HistoryComponent = __decorate([
    ...
    __metadata("design:paramtypes", [router_1.ActivatedRoute,
        ...
        index_1.PendingAssistantService])
], HistoryComponent);
