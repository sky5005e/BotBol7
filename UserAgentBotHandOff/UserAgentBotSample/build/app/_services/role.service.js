...
let RoleService = class RoleService {
    ...
    create(role) {
        return this.http.post('api/mqa/post', role, this.options).map((response) => response.json());
    }
    update(role) {
        return this.http.put('/api/users/' + role.Id, role, this.jwt()).map((response) => response.json());
    }
    //delete(id: number) {
