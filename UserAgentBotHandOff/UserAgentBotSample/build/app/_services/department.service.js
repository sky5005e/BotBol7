...
let DepartmentService = class DepartmentService {
    ...
    create(department) {
        return this.http.post('api/mqa/post', department, this.options).map((response) => response.json());
    }
    update(department) {
        return this.http.put('/api/users/' + department.Id, department, this.jwt()).map((response) => response.json());
    }
    //delete(id: number) {
