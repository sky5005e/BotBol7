...
const ng2_bs3_modal_1 = require("../../../node_modules/ng2-bs3-modal/ng2-bs3-modal");
...
let QuesAnswerComponent = class QuesAnswerComponent {
    ...
    LoadQAS() {
        ...
        this._qaService.get(global_1.Global.BASE_QAS_ENDPOINT)
            .subscribe(quesanswers => { this.quesanswers = quesanswers; this.indLoading = false; console.log('data', this.quesanswers); }
